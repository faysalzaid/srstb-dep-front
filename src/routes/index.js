...
const PgDetail = lazy(() => import("../components/newProjects/PGDetail"));

const PgList = lazy(() => import("../components/newProjects/PGList"));

const LeaveTypeList = lazy(() => import("../components/LeaveTypes/LeaveType"));
const LeaveList = lazy(() => import("../components/Leaves/LeaveList"));

const PayrollList = lazy(() => import("../components/payroll/PayrollList"));
const payrollDetail = lazy(() => import("../components/payroll/PayrollDetail"));

const LeaveDetail = lazy(() => import("../components/Leaves/LeaveDetail"));
...
const BidsList = lazy(() => import("../pages/BidList"));
...
const DesignationDetail = lazy(() => import("../pages/DesignationDetail"));
...
const ArchiveList = lazy(() => import("../components/Archives/ArchiveList"));

const AwardList = lazy(() => import("../components/Awards/AwardList"));
...
const AreaDetail = lazy(() => import("../components/Areas/AreaDetail"));
...
const FuelRequest = lazy(() => import("../request_pages/contents/FuelRequest"));
