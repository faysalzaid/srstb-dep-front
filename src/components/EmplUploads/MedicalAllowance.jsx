...
{medicalFile.files?       
        ...
        (medicalFile.files.map((md,index)=>
           ...
           <>
            <div className="flex-1 truncate"><a href={`${md.file}`} target='_blank'>Medical File</a><p className='text-bold'>Date | <span className='text-sm text-purple-500'>{md.createdAt.slice(0,10)}</span></p></div>  
