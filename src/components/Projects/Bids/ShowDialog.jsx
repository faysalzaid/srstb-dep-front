              ...
              <table>
                <tbody>
                  <tr>
                    ...
                    <td className='right-side'>{bidDetail?.name}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className='right-side'>{status}</td>
                  </tr>
                  {bidDetail?.license &&
                  <tr>
                    ...
                    <td className='right-side'>
                      <div className='flex items-center justify-between' style={{color: '#172b4d',fontSize: 17}}>
                        {bidDetail?.license.split("/").pop()}
                        <div className='flex items-center gap-2'>
                           <IconButton 
                             onClick={()=>{
                               const link = "https://docs.google.com/gview?url="+bidDetail?.license+"&embedded=true";
                               window.open(link)
                             }}
                  ...
                  <tr>
                    ...
                    <td className='right-side'>
                      <div className='flex items-center justify-between' style={{color: '#172b4d',fontSize: 17}}>
                        {bidDetail?.performa.split("/").pop()}
                        <div className='flex items-center gap-2'>
                           <IconButton 
                             onClick={()=>{
                               const link = "https://docs.google.com/gview?url="+bidDetail?.performa+"&embedded=true";
                               window.open(link)
                             }}
                             style={{border: '1px solid rgba(0,130,130,.1)'}}>
                              <GoBrowser color="#4a5a74" fontSize={21}/>
                  ...
                  <tr>
                    ...
                    <td className='right-side'>
                      <div className='flex items-center justify-between' style={{color: '#172b4d',fontSize: 17}}>
                        {bidDetail?.proposal.split("/").pop()}
                        <div className='flex items-center gap-2'>
                           <IconButton 
                             onClick={()=>{
                               const link = "https://docs.google.com/gview?url="+bidDetail?.proposal+"&embedded=true";
                               window.open(link)
                             }}
                             style={{border: '1px solid rgba(0,130,130,.1)'}}>
                              <GoBrowser color="#4a5a74" fontSize={21}/>
                  ...
                  <tr>
                    ...
                    <td className='right-side'>
                      <div className='flex items-center justify-between' style={{color: '#172b4d',fontSize: 17}}>
                        {bidDetail?.company.split("/").pop()}
                        <div className='flex items-center gap-2'>
                           <IconButton 
                             onClick={()=>{
                               const link = "https://docs.google.com/gview?url="+bidDetail?.company+"&embedded=true";
                               window.open(link)
                             }}
                             style={{border: '1px solid rgba(0,130,130,.1)'}}>
                              <GoBrowser color="#4a5a74" fontSize={21}/>
