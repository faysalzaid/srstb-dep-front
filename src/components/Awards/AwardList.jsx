    ...
    function openModal(){
      ...
      useEffect(()=>{
        const getData=async()=>{
            ...
            await axios.get(`${url}/awardletter`,{withCredentials:true}).then((resp)=>{
      ...
      const handleSubmit = async(e) => {
        ...
        await axios.post(`${url}/awardletter`,formData,{withCredentials:true}).then((resp)=>{
            if(resp.data.error){
                ...
                setAwardData((prev)=>[...prev,resp.data])
  ...
  const handleDelete = async()=>{
    ...
    return (
      ...
      {/* Delete Confirm section */}
        ...
        <Button size="small" onClick={openModal}>New Award Letter</Button>
  
      
        </TableContainer>

        <Modal isOpen={isOpen} onClose={closeModal}>
      <ModalHeader>Register Awards</ModalHeader>
      <ModalBody>
